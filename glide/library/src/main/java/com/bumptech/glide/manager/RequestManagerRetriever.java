  ...
  private SupportRequestManagerFragment getSupportRequestManagerFragment(
    ...
    if (current == null) {
      ...
      if (current == null) {
        ...
        fm.beginTransaction().add(current, FRAGMENT_TAG).commitAllowingStateLoss();
        Log.d("zimotag", "commit " + System.currentTimeMillis());
        // 这里说明pendingSupportRequestManagerFragments 就是个临时变量 为了大量fragment中大量图片做一个缓存处理
  ...
  public boolean handleMessage(Message message) {
    ...
    switch (message.what) {
      ...
      case ID_REMOVE_SUPPORT_FRAGMENT_MANAGER:
        ...
        Log.d("zimotag", "remove " + System.currentTimeMillis());
        break;
      default:
        handled = false;
        break;
